...
BLOG_TITLE = "Math and Python"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://mathandpython.adammichaelwood.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://mathandpython.adammichaelwood.com/"
BLOG_EMAIL = "adam.michael.wood@gmail.com"
BLOG_DESCRIPTION = "Learn math and Python programming at the same time."  # (translatable)
